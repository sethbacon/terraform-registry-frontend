...
describe('StorageMigrationWizard', () => {
  ...
  it('renders the dialog with all stepper labels when open', () => {
    render(<StorageMigrationWizard open={true} onClose={onClose} configs={mockConfigs} />, {
  ...
  it('does not render the dialog when closed', () => {
    render(<StorageMigrationWizard open={false} onClose={onClose} configs={mockConfigs} />, {
      wrapper: createWrapper(),
    })
