...
export const primaryNavItems: NavItem[] = [
  ...
  },
  {
    ...
    tooltipKey: 'nav.providersTooltip',
    icon: <Extension />,
    scope: null,
  },
  {
    ...
    items: [
      {
        ...
        tooltipKey: 'nav.admin.organizationsTooltip',
        icon: <Business />,
        scope: adminScope('/admin/organizations'),
      },
      {
        path: '/admin/roles',
        labelKey: 'nav.admin.roles',
        tooltipKey: 'nav.admin.rolesTooltip',
        icon: <Badge />,
        scope: adminScope('/admin/roles'),
      },
      {
        path: '/admin/platform-admins',
        labelKey: 'nav.admin.platformAdmins',
        tooltipKey: 'nav.admin.platformAdminsTooltip',
        icon: <AdminPanelSettings />,
        scope: adminScope('/admin/platform-admins'),
      },
      {
        path: '/admin/users',
        labelKey: 'nav.admin.users',
        tooltipKey: 'nav.admin.usersTooltip',
        icon: <People />,
        scope: adminScope('/admin/users'),
      },
      {
        path: '/admin/oidc',
        labelKey: 'nav.admin.oidcGroups',
        tooltipKey: 'nav.admin.oidcGroupsTooltip',
        icon: <ManageAccounts />,
        scope: adminScope('/admin/oidc'),
      },
      {
        path: '/admin/scim',
        labelKey: 'nav.admin.scim',
        tooltipKey: 'nav.admin.scimTooltip',
        icon: <SyncAlt />,
        scope: adminScope('/admin/scim'),
      },
      {
        path: '/admin/mtls',
        labelKey: 'nav.admin.mtlsCerts',
        tooltipKey: 'nav.admin.mtlsCertsTooltip',
        icon: <VerifiedUser />,
        scope: adminScope('/admin/mtls'),
      },
      {
        path: '/admin/apikeys',
        labelKey: 'nav.admin.apiKeys',
        tooltipKey: 'nav.admin.apiKeysTooltip',
        icon: <Key />,
        scope: adminScope('/admin/apikeys'),
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        labelKey: 'nav.admin.sourceControl',
        tooltipKey: 'nav.admin.sourceControlTooltip',
        icon: <GitHub />,
        scope: adminScope('/admin/scm-providers'),
      },
    ],
  },
  {
    ...
    items: [
      {
        path: '/admin/mirrors',
        labelKey: 'nav.admin.providerConfig',
        tooltipKey: 'nav.admin.providerConfigTooltip',
        icon: <CloudDownload />,
        scope: adminScope('/admin/mirrors'),
      },
      {
        path: '/admin/terraform-mirror',
        labelKey: 'nav.admin.binariesConfig',
        tooltipKey: 'nav.admin.binariesConfigTooltip',
        icon: <GetApp />,
        scope: adminScope('/admin/terraform-mirror'),
      },
      {
        path: '/admin/approvals',
        labelKey: 'nav.admin.approvals',
        tooltipKey: 'nav.admin.approvalsTooltip',
        icon: <HourglassEmpty />,
        scope: adminScope('/admin/approvals'),
      },
      {
        path: '/admin/version-approvals',
        labelKey: 'nav.admin.versionApprovals',
        tooltipKey: 'nav.admin.versionApprovalsTooltip',
        icon: <HourglassEmpty />,
        scope: adminScope('/admin/version-approvals'),
      },
      {
        path: '/admin/policies',
        labelKey: 'nav.admin.mirrorPolicies',
        tooltipKey: 'nav.admin.mirrorPoliciesTooltip',
        icon: <Policy />,
        scope: adminScope('/admin/policies'),
      },
    ],
  },
  {
    ...
    items: [
      {
        path: '/admin/storage',
        labelKey: 'nav.admin.storage',
        tooltipKey: 'nav.admin.storageTooltip',
        icon: <Storage />,
        scope: adminScope('/admin/storage'),
      },
      {
        path: '/admin/security-scanning',
        labelKey: 'nav.admin.securityScanning',
        tooltipKey: 'nav.admin.securityScanningTooltip',
        icon: <Security />,
        scope: adminScope('/admin/security-scanning'),
      },
      {
        path: '/admin/notifications',
        labelKey: 'nav.admin.notifications',
        tooltipKey: 'nav.admin.notificationsTooltip',
        icon: <Notifications />,
        scope: adminScope('/admin/notifications'),
      },
      {
        path: '/admin/branding',
        labelKey: 'nav.admin.branding',
        tooltipKey: 'nav.admin.brandingTooltip',
        icon: <Palette />,
        scope: adminScope('/admin/branding'),
      },
      {
        path: '/admin/audit-logs',
        labelKey: 'nav.admin.auditLogs',
        tooltipKey: 'nav.admin.auditLogsTooltip',
        icon: <History />,
        scope: adminScope('/admin/audit-logs'),
      },
    ],
  },
]
